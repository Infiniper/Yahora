        ...
        <div className={styles.footerRow}>
          <div className={styles.stats}>
            ...
            <button className={`${styles.statBtn} ${product.is_liked ? styles.statBtnLiked : ""}`} onClick={handleLike}>
              <HeartIcon filled={product.is_liked} size={16} /><span>{likeCount}</span>
            </button>

            <button className={styles.statBtn} onClick={(e) => {
                e.stopPropagation(); 
                if (onCardClick) onCardClick(`${product.id}#comments`);
              }}>
              <CommentIcon size={16} /><span>{commentCount}</span>
            </button>
        ...
        <div className={styles.timeAvatar}>
          ...
          {isOwner ? (
            <div className={styles.ownerActions}>
              {product.status === "sold" ? (
                <>
                  <span className={styles.cardSoldTo} style={{ marginRight: 'auto', fontWeight: 'bold', color: '#f87171' }}>
