...
const SettingsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="dropdown-icon">
            ...
            <div className="profile-menu" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="profile-dropdown">
                  <Link to="/dashboard" onClick={() => setIsDropdownOpen(false)} className="dropdown-item">
                    <DashboardIcon />
                    Dashboard
                  </Link>
                  <Link to="/settings" onClick={() => setIsDropdownOpen(false)} className="dropdown-item">
                    <SettingsIcon />
                    Settings
                  </Link>
          ...
          <Link to="/auth" style={{ textDecoration: 'none' }}>
            <button className="login-button">
              <span className="login-button__icon-wrapper">
                <svg viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="login-button__icon-svg" width="10">
                  <path d="M13.376 11.552l-.264-10.44-10.44-.24.024 2.28 6.96-.048L.2 12.56l1.488 1.488 9.432-9.432-.048 6.912 2.304.024z" fill="currentColor"></path>
                </svg>
                <svg viewBox="0 0 14 15" fill="none" width="10" xmlns="http://www.w3.org/2000/svg" className="login-button__icon-svg login-button__icon-svg--copy">
                  <path d="M13.376 11.552l-.264-10.44-10.44-.24.024 2.28 6.96-.048L.2 12.56l1.488 1.488 9.432-9.432-.048 6.912 2.304.024z" fill="currentColor"></path>
                </svg>
              </span>
              Login / Sign up
