       ...
       if (userId && token) {
         try {
           ...
           if (res.ok) {
             ...
             if (data.profile && data.profile.avatar_url) setAvatarUrl(data.profile.avatar_url);
   ...
   <div className={styles.navElements}>
     ...
     <div className={`${styles.navLinks} ${isMenuOpen ? styles.active : ""}`}>
       ...
       <div className={styles.mobileMenuHeader}>
         <img src="/yahora_logo.svg" alt="Yahora" className={styles.mobileLogo} />
       ...
       <NavLink to="/marketplace" end className={navLinkClass} onClick={closeMenu}>
       ...
       <NavLink to="/messages" end className={navLinkClass} onClick={closeMenu} style={{ position: "relative" }}>
         <span>Messages</span>
         {unreadCount > 0 && (
     ...
     <div className={styles.navActions}>
       {isAuthenticated ? (
         <div className={styles.userActions}>
           ...
           <div className={styles.profileMenu} ref={dropdownRef}>
             <button
               ...
               style={avatarUrl || userName ? { padding: 0, overflow: "hidden", border: "none" } : {}}
             >
               {avatarUrl ? (
                 <img src={avatarUrl} alt="User Avatar" className={styles.navAvatarImg} style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "50%" }} />
               ) : userName ? (
                 <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: `linear-gradient(135deg, hsl(${hue}, 60%, 55%), hsl(${hue + 40}, 60%, 45%))`, color: "white", fontWeight: "bold", fontSize: "15px", borderRadius: "50%", border: "2px solid #2a082a" }}>
                   {initials}
                 </div>
               ) : (
                 <UserIcon />
                 ...
                 <button onClick={handleLogout} className={`${styles.Btn} ${styles.logoutBtn}`}>
                   <div className={styles.sign}>
                     <svg viewBox="0 0 512 512">
                       <path d="M377.9 105.9L500.7 228.7c7.2 7.2 11.3 17.1 11.3 27.3s-4.1 20.1-11.3 27.3L377.9 406.1c-6.4 6.4-15 9.9-24 9.9c-18.7 0-33.9-15.2-33.9-33.9l0-62.1-128 0c-17.7 0-32-14.3-32-32l0-64c0-17.7 14.3-32 32-32l128 0 0-62.1c0-18.7 15.2-33.9 33.9-33.9c9 0 17.6 3.6 24 9.9zM160 96L96 96c-17.7 0-32 14.3-32 32l0 256c0 17.7 14.3 32 32 l 64 0 c 17.7 0 32 14.3 32 32s-14.3 32-32 32l-64 0c-53 0-96-43-96-96L0 128C0 75 43 32 96 32l64 0 c 17.7 0 32 14.3 32 32s-14.3 32-32 32z"></path>
                     </svg>
                   </div>
         ...
         <Link to="/auth" style={{ textDecoration: "none" }} onClick={closeMenu}>
